...
public class CssLocators {
    ...
    public void textBox() {
        ...
        WebElement address1 = driver.findElement(By.cssSelector("#permanentAddress-label"));
    ...
    public void radioButton()  {
        ...
        WebElement elementP = driver.findElement(By.cssSelector("div[class='col-12 mt-4 col-md-6'] :nth-child(2) :nth-child(5)"));
